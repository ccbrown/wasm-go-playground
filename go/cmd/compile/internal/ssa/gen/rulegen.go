...
func genRules(arch arch) {
	...
	fmt.Fprintln(w, "import \"github.com/ccbrown/go-web-gc/go/cmd/internal/obj\"")
	fmt.Fprintln(w, "import \"github.com/ccbrown/go-web-gc/go/cmd/internal/objabi\"")
	fmt.Fprintln(w, "import \"github.com/ccbrown/go-web-gc/go/cmd/compile/internal/types\"")
