...
import (
	intdwarf "github.com/ccbrown/go-web-gc/go/cmd/internal/dwarf"
	objfilepkg "github.com/ccbrown/go-web-gc/go/cmd/internal/objfile" // renamed to avoid conflict with objfile function
	"debug/dwarf"
	"errors"
	"fmt"
	"github.com/ccbrown/go-web-gc/go/internal/testenv"
	"io/ioutil"
	"os"
	"os/exec"
	"path/filepath"
